...
public class EinlagernGUI extends javax.swing.JFrame {
    ...
    private void buttonEinlagernActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEinlagernActionPerformed
       ...
       allValues.add(Integer.parseInt(tfArtNr.getText(),10));
       allValues.add(Integer.parseInt(tfAmount.getText(),10));
       //if (!general.Check.showErrorNonPositive(allValues)){
           try {
               Arti artikel = new Arti();
               int i = artikel.UpdateArtikel(Integer.parseInt(tfAmount.getText(),10), Integer.parseInt(tfArtNr.getText(),10));
               if(i == 0){
